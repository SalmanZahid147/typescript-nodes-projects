...
// Example usage
const magicians2: string[] = ['Harry Houdini', 'David Blaine', 'Penn Jillette', 'Teller'];
...
function makeSandwich(...ingredients :any) {
...
function carInfo(manufacturer :any, model :any, ...options :any) {
    let car = {
